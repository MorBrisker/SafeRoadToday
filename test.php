...
<html>
	...
	function getRoadNames(placeIds, locations){
        ...
        var colors = ["#FF0000", "#00FF00", "#0000FF", "#FFFF00", "#FF00FF", "#00FFFF", "#00FF00", "#0000FF", "#FFFF00", "#FF00FF", "#00FFFF"];
        var polylines = [];
            ...
            for (i = 0; i < legs.length; i++) {
                ...
                for (j = 0; j < steps.length; j++) {
                    ...
                    stepPolyline.setOptions({
                        strokeColor: colors[globi[j].risk-1]
                    })
...
/*          $.post( "getRouteRiskLevel.php", {
      ...
      AutocompleteDirectionsHandler.prototype.route = function() {
		...
		//TODO:was 1000-is 100 correct?
              if(myRoute.steps[i].distance.value > 100){
                // create road
                road = {};
